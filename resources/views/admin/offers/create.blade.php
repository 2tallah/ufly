...
@section('title')
    @lang('common.add') @lang('common.offer')
@endsection
@section('css')
@endsection
@section('styles')
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('common.add') @lang('common.offer')</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>@lang('common.add') @lang('common.offer')</h2>
                        </div>
                        <div class="body">
                            <form action="{{url(app()->getLocale().'/admin/offers')}}" id="basic-form" method="POST"
                                ...
                                <div class="form-body offset-2">
                                    ...
                                    <div class="form-group row">
                                        <label for="service_id" class="col-md-3 col-form-label">
                                            @lang('common.service')
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-6">
                                            <select name="services[]" multiple id="service">
{{--                                                <option selected value="">@lang('common.select')</option>--}}
                                        ...
                                        <div class="form-group row{{ $errors->has('title_'.$key) ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="title_{{$key}}"
                                                       ...
                                                       placeholder="@lang('common.title') {{$value}}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="form-group row{{ $errors->has('description_'.$key) ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="description_{{$key}}"
                                                       required name="description_{{$key}}"
                                                       placeholder="@lang('common.description') {{$value}}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    @endforeach
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="old_price" required
                                                   name="old_price" placeholder="@lang('common.old_price')">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="price" required
                                                   name="price" placeholder="@lang('common.price')">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="rating" required
                                                   name="rating" placeholder="@lang('common.rating')">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
