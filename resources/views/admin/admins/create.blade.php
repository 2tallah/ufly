            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-md-12">
                        <h2>{{__('common.add')}} {{__('common.admin')}}</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('common.add')}} {{__('common.admin')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{url(app()->getLocale().'/admin/admins')}}" id="basic-form" method="POST"
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                    <span class="btn btn-secondary btn-file"><span
                                                            class="fileinput-new">{{__('common.select_image')}}</span><span
                                                            class="fileinput-exists">{{__('common.change')}}</span><input accept="image/*" type="file"
                                                                                                         name="image"></span>
