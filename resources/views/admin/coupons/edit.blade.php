...
@section('title')
    @lang('common.edit') @lang('common.coupon')
@endsection
@section('css')
@endsection
@section('styles')
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('common.edit') @lang('common.coupon')</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>@lang('common.edit') @lang('common.coupon')</h2>
                        </div>
                        <div class="body">
                            <form action="{{url(app()->getLocale()."/admin/coupons/$coupon->id")}}" id="basic-form" method="post"
                                        ...
                                        <div class="form-group row{{ $errors->has('name_'.$key) ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="name_{{$key}}"
                                                       value="{{$coupon->getTranslation('name', $key)}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="discount_amount" required
                                                       ...
                                                       placeholder="@lang('common.discount_amount')">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
