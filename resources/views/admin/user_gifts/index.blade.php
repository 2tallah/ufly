                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('common.user_gifts')</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="m-b-15">
                                <form id="search_form">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="s_gift_id">@lang('common.gift')</label>
                                            <select class="form-control" id="s_gift_id" >
                            ...
                            <div class="m-b-15">
                                <a href="{{url('admin/user_gifts/create')}}" id="info" class="btn btn-primary"><i
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/user_gifts")}}/';
        ...
        var oTable = $('.dataTable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/user_gifts/indexTable')}}',
                data: function (d) {
                    d.user_id = $('#s_user_id').val();
                    d.gift_id = $('#s_gift_id').val();
                }
            },
            columns: [
                {
