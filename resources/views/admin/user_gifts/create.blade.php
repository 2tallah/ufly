...
@section('title')
    @lang('common.add') @lang('common.user_gift')
@endsection
@section('css')
@endsection
@section('styles')
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('common.add') @lang('common.user_gift')</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>@lang('common.add') @lang('common.user_gift')</h2>
                        </div>
                        <div class="body">
                            <form action="{{url(app()->getLocale().'/admin/user_gifts')}}" id="basic-form" method="POST"
