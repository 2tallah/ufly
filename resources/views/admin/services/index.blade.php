                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('common.services')</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="m-b-15">
                                <a href="{{url('admin/services/create')}}" id="info" class="btn btn-primary"><i
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/services")}}/';
        ...
        var oTable = $('.dataTable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/services/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
